...
test_that("The happy hour starts", {
  my_html_report <- happy_hour(
    ...
    mygenesets = res_enrich_IFNg_vs_naive$gs_description[2:3],
  ...
  my_pdf_report <- happy_hour(
    ...
    annotation_obj = anno_df,
    project_id = "testsuite",
    mygenesets = res_enrich_IFNg_vs_naive$gs_description[1:2],
    mygenes = deseqresult2df(res_de)$SYMBOL[1:5],
...
test_that("Errors and warnings are thrown", {
  ...
  expect_warning(
    happy_hour(
      ...
      annotation_obj = anno_df,
      project_id = "testsuite",
      mygenesets = res_enrich_IFNg_vs_naive$gs_description[5:6],
      mygenes = deseqresult2df(res_de)$SYMBOL[1:5],
  ...
  expect_error(
    happy_hour(
      ...
      annotation_obj = anno_df,
      project_id = "testsuite",
      mygenesets = res_enrich_IFNg_vs_naive$gs_description[3:4],
      mygenes = deseqresult2df(res_de)$SYMBOL[1:5],
