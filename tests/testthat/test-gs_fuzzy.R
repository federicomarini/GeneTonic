...
test_that("Fuzzy clustering on example set", {
  ...
  fake_re$gs_genes <- c("gene1,gene2,gene3,gene4,gene5,gene6,gene7,gene8,gene9,gene10",
  ...
  expect_equal(
    ...
    c("Representative", "Member", "Member", "Member",
...
test_that("Fuzzy clustering on GeneTonic set", {
  ...
  fuzzy_gtexample <- gs_fuzzyclustering(res_enrich = res_enrich,
