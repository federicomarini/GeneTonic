...
#' @importFrom bs4Dash bs4Card bs4DashBody bs4DashControlbar bs4DashFooter bs4DashNavbar bs4DashPage bs4DashSidebar bs4InfoBox bs4InfoBoxOutput bs4SidebarMenu bs4SidebarMenuItem bs4TabItem bs4TabItems bs4ValueBox bs4ValueBoxOutput renderbs4InfoBox renderbs4ValueBox bs4TabCard
...
#' @importFrom DT datatable dataTableOutput renderDataTable formatRound formatStyle JS
...
#' @importFrom igraph add_edges as_adjacency_matrix as_biadjacency_matrix degree delete_edges delete_vertices "%du%" E "E<-" graph_from_data_frame induced_subgraph make_full_graph permute strength V "V<-" vcount as_edgelist
...
#' @importFrom stats var dist hclust as.dendrogram as.dist cmdscale median order.dendrogram runif na.omit
#' @import SummarizedExperiment
#' @importFrom tidyr separate_rows pivot_longer
#' @importFrom tippy with_tippy
#' @importFrom tools file_ext file_path_sans_ext
#' @importFrom utils read.delim sessionInfo browseURL citation data write.table head packageDescription
#' @importFrom visNetwork renderVisNetwork visExport visIgraph visNetworkOutput visOptions
#' @importFrom viridis viridis
#' @importFrom mosdef deresult_to_df gene_plot geneinfo_to_html go_to_html map_to_color styleColorBar_divergent create_link_GO create_link_NCBI create_link_GeneCards create_link_GO 
#'
#' @name GeneTonic-pkg
#' @keywords internal
"_PACKAGE"
