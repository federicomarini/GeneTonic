...
```{r pcaplots, eval=TRUE}
vst_macrophage <- vst(dds_macrophage)
# rld_macrophage <- rlog(dds_macrophage)

plotPCA(vst_macrophage, intgroup = "condition") 
plotPCA(vst_macrophage, intgroup = "line") 

## For finer control on the aspect and labeling of the samples:
...
de_symbols_SL1344_vs_naive <- deseqresult2df(res_macrophage_SL1344_vs_naive, FDR = 0.05)$SYMBOL
...
cnetplot(ego_IFNg_vs_naive)
cnetplot(ego_SL1344_vs_naive)
```
